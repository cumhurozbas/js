...
function listFoods (f_type)  {
  ...
  {
    let foods=menu.filter(function(menu)
    {
      return menu.category===f_type;
    
    }
  
    );
   foods.forEach(value =>{ 
     allFoods+=createFoods(value);
   });
   console.log(foods);
  }
...
document.querySelector("#china").addEventListener("click",function(){listFoods("China"); });
document.querySelector("#korea").addEventListener("click",function(){listFoods("Korea"); });
document.querySelector("#japan").addEventListener("click",function(){listFoods("Japan"); });
document.querySelector("#all").addEventListener("click",function(){listFoods("All"); });
document.addEventListener("DOMContentLoaded",listFoods("All"));